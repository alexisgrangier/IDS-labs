...
```{r}
#a.
dplyr::anti_join(flights, planes, by = 'tailnum') |> count()

?anti_join

#b. 
dplyr::anti_join(flights, planes, by = 'tailnum') |> 
  group_by(carrier) |> 
...
```{r}
# do the same with 'airports' df
data(airports)
view(airports) #inspect data
...
```{r}
dplyr::left_join(flights_db, airlines_db) |> 
