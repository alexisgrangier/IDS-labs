...
reg_3_formula_string <- paste("life_expectancy ~ gdp + population + alcohol")
formula_reg_3 <- as.formula(reg_3_formula_string)
reg_3 <- lm(formula_reg_3, data = life_expec_dat)
reg_3


reg_4_formula_string <- paste(reg_3_formula_string, "+ gdp * population")
reg_4_formula_string
formula_reg_4 <- as.formula(reg_4_formula_string)
reg_4 <- lm(formula_reg_4, data = life_expec_dat)
...
mod_table <- modelsummary::modelsummary(multiv_model_out[29:31], 
                                        ...
                                        gof_omit = 'DF|Deviance|Log.Lik|AIC|BIC',
                                        title = 'An Improved Regression Table',
                                        notes = "Note : This data originated from the World Health Organization",
                                        escape = FALSE)
